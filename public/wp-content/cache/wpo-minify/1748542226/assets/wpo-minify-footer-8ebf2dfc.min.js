document.addEventListener("DOMContentLoaded", function () {
  (PostViewsCounter = {
    ...
    init: function (e) {
      "rest_api" === e.mode
        ? (this.promise = this.request(e.requestURL, {}, "POST", {
            "Content-Type": "application/x-www-form-urlencoded; charset=utf-8",
            "X-WP-Nonce": e.nonce,
          }))
        : (this.promise = this.request(
            e.requestURL,
            { action: "pvc-check-post", pvc_nonce: e.nonce, id: e.postID },
            "POST",
            {
              "Content-Type":
      ...
      return fetch(e, i)
        ...
        .then(function (e) {
          try {
            "object" == typeof e &&
              null !== e &&
              r.triggerEvent("pvcCheckPost", e);
          } catch (t) {
            console.log("Invalid JSON data"), console.log(t);
          }
        })
        .catch(function (e) {
          console.log("Invalid response"), console.log(e);
        });
    },
    ...
    triggerEvent: function (e, t) {
      let n = new CustomEvent(e, { bubbles: !0, detail: t });
      document.dispatchEvent(n);
    },
  }).init(pvcArgsFrontend);
});
(function () {
  ...
  (r.m = i),
    ...
    (function () {
        ...
        void 0 === g &&
          ...
          (u.hasClass("sticky-shrink")
            ? ((g = h.hasClass("hide-for-sticky") ? h.height() : 0),
              ...
              (v = 1 + g))
            : ((g = d.height() + 100),
              (v = h.hasClass("hide-for-sticky") ? h.height() + 1 : 1))),
          y
            ? "down" === t || e < v
              ? e < v
                ? w()
        ...
        C.length &&
          ...
          (E = requestAnimationFrame(() => {
            for (let e = 0; e < C.length; e++)
              C[e].element.offsetParent ? T(C[e]) : C.splice(e, 1);
          })));
      }
      function T(e) {
        !(function (e) {
      ...
      window.addEventListener("scroll", L, { passive: !0 }),
        ...
        r(8417),
        jQuery.fn.flickity ||
          ((A.isFlickityStub = !0), (jQuery.fn.flickity = A)),
        (jQuery.fn.lazyFlickity = function (e) {
          const t = B((n) => {
            if (n.isIntersecting) {
              if (
                (t.unobserve(n.target),
                !jQuery.fn.flickity || jQuery.fn.flickity === A)
              )
                return r
                  .e(309)
      ...
      const z = B((e) => {
        e.intersectionRatio > 0 &&
          (z.unobserve(e.target), jQuery(e.target).addClass("bg-loaded"));
      });
                    ...
                    (function (e) {
                      ...
                      const d = function () {
                          ...
                          const o = window.scrollY + n - Math.round(a?.top),
                            ...
                            d = Math.max(
                              Math.min(c, Math.round(a?.height - r?.height)),
                              0
                            );
                          let h = null,
                            f = null;
